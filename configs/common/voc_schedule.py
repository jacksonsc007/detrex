...
lr_multiplier_50ep_bs16 = default_voc_scheduler(50, 40, 0)
lr_multiplier_36ep_bs16 = default_voc_scheduler(36, 30, 0)
lr_multiplier_24ep_bs16 = default_voc_scheduler(24, 20, 0)
lr_multiplier_12ep_bs16 = default_voc_scheduler(12, 11, 0)

lr_multiplier_50ep_bs8 = default_voc_scheduler(50, 40, 0, 8)
lr_multiplier_36ep_bs8 = default_voc_scheduler(36, 30, 0, 8)
lr_multiplier_24ep_bs8 = default_voc_scheduler(24, 20, 0, 8)
lr_multiplier_12ep_bs8 = default_voc_scheduler(12, 11, 0, 8)

lr_multiplier_50ep_bs4 = default_voc_scheduler(50, 40, 0, 4)
lr_multiplier_36ep_bs4 = default_voc_scheduler(36, 30, 0, 4)
lr_multiplier_24ep_bs4 = default_voc_scheduler(24, 20, 0, 4)
lr_multiplier_12ep_bs4 = default_voc_scheduler(12, 11, 0, 4)
